...
<body>
    ...
    <main>
        ...
        <div class="nieuws">
            <h1>Nieuws</h1>
            <article>
                <h1>UPDATE Chiro Zondagen</h1>
                <p id="timestamp">donderdag, 18 februari, 2021 - 08:56</p>
                <p>
We gaan weer opstarten en dit keer ook voor de oudsten!🥳<br>
Iedereen is welkom vanaf 7 februari, dus deze zondag moeten we nog even wachten.<br>
Natuurlijk houden wij ons ook nog steeds aan de algemene maatregelen (chiro.be/corona).<br>
Voor de jongste leden zullen de uren ongeveer van 14u tot 17u30 zijn, maar de exacte uren worden volgende zaterdag nog meegedeeld als we de juiste aantallen weten.<br>
Voor de oudste leden gaat de chiro door van 14u tot 19u, maar wel op een andere locatie. (Eigen leiding stuurt nog concretere informatie door)<br>
Ook gaan we niet eten op de chiro, enkel een koek mag.<br><br>
 
Wij kijken er al enorm hard naar uit!!<br><br>
 
Groetjes van de leiding en VB </p>
            </article>
            <article>
                <h1>Geen Chiro meer voor een tijdje...</h1>
                <p id="timestamp">zaterdag, 31 oktober, 2020 - 17:55</p>
                <p>

                Beste ouders en leden,<br>
Omdat het morgen een feestdag is, is het ook GEEN Chiro!<br>
Daarnaast hebben wij in overleg met alle leiding en VB’s beslist om naast de oudste ploegen ook de jongste ploegen NIET meer naar de Chiro te laten komen tot het weer voor iedereen is toegestaan. Dit is voor iedereen een spijtige, maar wel een veilige keuze. Wij hebben voorlopig geen zicht op wanneer we wel terug zullen kunnen beginnen, maar hier communiceren we zeker nog over verder. We kijken al enorm uit naar de dag dat we jullie weer allemaal mogen verwelkomen!<br>
Hiernaast hebben we ook nog leuk nieuws, want onze eerste tapperskrant is er. Jullie kunnen ze hier vinden:<br>
<a href="https://drive.google.com/file/d/17mztlSjgc_3OK5ADkBka9clTbE-HjPb8/view?fbclid=IwAR0p9dLAW216j6Yxy_5BHERLud6eLEdnLMHqWXey2N9xyLYBTLtxjx1ZR-g" target="_blank">https://drive.google.com/.../17mztlSjgc.../view...</a><br>
Veel leesplezier!<br>
